...
% 基本色
\colorlet{fgcolor}{BrightGray}
\colorlet{bgcolor}{BlackBlue}
% その他の色
\colorlet{titlebgcolor}{BrightBlue}
\colorlet{bodybgcolor}{LightBlue}
\colorlet{examplefgcolor}{mLightGreen!70!white}
\colorlet{alertfgcolor}{mLightBrown!70!white}
\colorlet{structurefgcolor}{cyan!50!white}
\colorlet{footlinebgcolor}{cyan!50!black}
...
\begin{document}
  ...
  \begin{frame}[noframenumbering,plain]{}{}%
    \begin{tikzpicture}[remember picture, overlay,every node/.style={inner sep=0pt,outer sep=0pt}]%
      ...
      \node[above left] at ($(current page.south east)+(-\rmargin,1em-2pt)$){\includegraphics[width=3cm]{dummy_logo_white.png}};%
      \node[below left] at ($(current page.north east)+(-\rmargin,-1em+2pt)$){\includegraphics[width=3cm]{dummy_logo_white.png}};%
      \node[below right] at ($(current page.north west)+(\lmargin,-1em+2pt)$){\includegraphics[width=3cm]{dummy_logo_white.png}};%
    \end{tikzpicture}%
    \titlepage
    %% 部外秘をオーバーレイ
